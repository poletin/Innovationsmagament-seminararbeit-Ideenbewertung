...
%% des Dokuments.
\setzematrikelnr{666666}
\setzekurs{TMINF17}
\setzetitel{Kriterien für die Ideenbewertung}
\setzedatumAbgabe{2. August 2018}
\setzefirma{SAP SE}
...
% \setzedhbw{Karlsruhe}
\setzebetreuer{Prof. Dr. Florian Simons}
% \setzegutachter{Dhrin}
\setzezeitraum{12 Wochen}
\setzearbeit{Seminararbeit}
\setzeautor{Lea Poletin}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
